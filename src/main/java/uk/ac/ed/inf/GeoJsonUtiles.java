...
public class GeoJsonUtiles {
    ...
    /**
     * Constructer of GeoJsonUtiles class. In the constructer method, function get
     * the landmark and no fly zone location in type of {@link FeatureCollection},
     * then transform no fly zone location into list of {@link List<LongLat>}.
     *
     * @param port the communication web port to the server
     */
    public GeoJsonUtiles(String port) {
        this.port = port;
     ...
     * 
     * @return all landmarks in type of {@link List<LongLat>}
     */
     ...
     * 
     * @return no fly zones edgepoint in type of {@link List<List<LongLat>>}
     */
     ...
     * @return the infotmation of the geojson filein type of
     *         {@link FeatureCollection}.
     * 
     */
    private FeatureCollection getFeatureCollection(String name) {
        String fcString = ServerUtiles.get(address + name);
