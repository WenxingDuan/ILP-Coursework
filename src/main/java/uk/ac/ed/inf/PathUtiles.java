...
public class PathUtiles {
     ...
     * input angle. (eg. input 12.4, return 20.0)
     * 
     ...
     * input angle. (eg. input 12.4, return 10.0)
     * 
     * @param degree the input degree
     ...
     * touchs or too close to the no-fly zones.
     * 
     ...
     * found if Design Manual 100.100.100
     * 
     * @param start        the starting position
     * @param end          the ending position
     * @param slope        the degree to be offseted on both start and end points on
     ...
     * details can be found if Design Manual 100.100.100
     * 
     * @param start        the starting position
     * @param end          the ending position
     * @param upperSlope   the degree to be offseted in the counterclockwise
     *                     direction on starting point / the degree to be offseted
     *                     in the clockwise direction on ending point
     * @param lowerSlope   the degree to be offseted in the clockwise direction on
     *                     starting point / the degree to be offseted in the
    ...
    public static List<LongLat> advanceOrganizePath(LongLat start, LongLat end, double upperSlope, double lowerSlope,
        ...
        //
        // when offseting counterclockwise, upperBound is also the degree on the end
        // point in the triangle fromed by start, middle and end
        double upperBound = upperDegree(degree) - 10 + upperSlope;
        // calculate the angle of the starting point after offset in the
        // clockwise direction
        //
        // when offseting clockwise, lowerBound is also the degree on the end
        // point in the triangle fromed by start, middle and end
        double lowerBound = lowerDegree(degree) + 10 - lowerSlope;

        // calculate the length of the triangle fromed by start, middle and end
        ...
        //
        // midpoint coordinates of offseting counterclockwise
        ...
        // midpoint coordinates of offseting clockwise
    ...
    /**
     * Method to find the shortest (lowest bettery cost) path among all input paths
     * 
     * @param pathOptions the list of all paths key points list
     * 
     * @return the paths key points list with the shortest distance (lowest bettery
     *         cost)
     */
    public static List<LongLat> chooseShortestPath(List<List<LongLat>> pathOptions) {
        ...
        // go over all paths find the path index with lowest bettery cost
    ...
    /**
     * Method to calculate the bettery cost of the input path
     * 
     * @param path the input path
     * 
     * @return the bettery cost of the input path
     */
    ...
    /**
     * Method to calculate the bettery cost to move from the input start to end
     * 
     * @param start the starting position
     * @param end   the ending position
     * 
     * @return the bettery cost from the start to end
     */
